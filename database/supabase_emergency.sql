-- AmarSheba emergency data converted for PostgreSQL/Supabase.
...
insert into public.emergency_services (name, category, phone, description, district, address, latitude, longitude, is_active) VALUES
